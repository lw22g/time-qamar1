// ==============================================================================
// Firebase Client Integration Layer with Google Sheets Auto-Sync
// ==============================================================================
...
async function fbCheckIn(userId) {
  ...
  return { success: true, message: 'تم تسجيل حضورك بنجاح في Firebase. يومك سعيد!' };
}
...
async function fbGetMyNotifications(userId) {
  ...
  notifs.sort((a, b) => new Date(b.created_at || b.date || 0) - new Date(a.created_at || a.date || 0));
  return notifs;
}
